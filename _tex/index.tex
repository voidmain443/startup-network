...
\hypersetup{
  pdftitle={Startup Network},
  pdfauthor={Junha Park},
  pdfkeywords={Startup Network, Scocial Network},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\begin{document}
\title{Startup Network}

\authors{Junha Park\affil{1}}
\affiliation{1}{Curvenote, }
\correspondingauthor{Junha Park}{paulpark@hanyang.ac.kr}
...
\textsubscript{Source:
\href{https://voidmain443.github.io/startup-network/index-preview.html}{Article
Notebook}}
